...
import com.agendador.notificacao.dto.TarefasDTO;
import com.agendador.notificacao.infraestructure.exception.EmailException;
...
public class EmailService {
    ...
    public void enviaEmail(TarefasDTO dto) {
        ...
        try {
            ...
            mimeMessageHelper.setSubject("Notigficação de Tarefa");
